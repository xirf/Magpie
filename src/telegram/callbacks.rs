...
use super::menu::{
    list_active_torrents, list_categories, render_client_settings, render_torrent_details,
    send_menu,
};
use super::state::{get_resolved_user, translate, BotState};
...
pub async fn handle_callback_query(
    ...
    match prefix {
        ...
        "menu_pause_resume" => {
            ...
            let keyboard = InlineKeyboardMarkup::new(vec![
                ...
                vec![
                    ...
                    InlineKeyboardButton::callback(
                        translate(&user, "▶️ Resume All", None),
                        "resume_all:",
                    ),
                ],
        ...
        "export" => match state.manager.export_torrent(arg1).await {
            Ok((bytes, filename)) => {
                let _ = bot
